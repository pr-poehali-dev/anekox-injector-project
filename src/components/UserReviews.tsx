...
export function UserReviews() {
  const reviews = [
    ...
    },
    {
      ...
      text: 'Невероятно крутой инжектор! Работает как часы, никаких проблем. Библиотека скриптов тоже огонь. Всем советую попробовать!'
    },
    {
      name: 'sxi',
      avatar: 'SX',
      ...
      text: 'Использую ANEKOX каждый день, просто идеально! Быстро, надежно, безопасно. Лучше не найти!'
    }
  ];
