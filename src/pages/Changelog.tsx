  ...
  const releases = [
    {
      ...
      type: 'major',
      changes: [
        { type: 'new', text: 'Революционная система защиты от обнаружения' },
        { type: 'new', text: 'Поддержка всех новых Roblox обновлений' },
        { type: 'improved', text: 'Скорость работы увеличена на 60%' },
        { type: 'fixed', text: 'Устранены все известные критические баги' }
      ]
    },
    {
      version: '3.0.5',
      ...
      type: 'patch',
      changes: [
        { type: 'fixed', text: 'Исправлена проблема с запуском на Windows 11 24H2' },
        { type: 'improved', text: 'Оптимизирована работа с памятью' },
        { type: 'fixed', text: 'Устранен баг с зависанием при инъекции' }
      ]
    },
    {
      version: '3.0.0',
      ...
      type: 'major',
      changes: [
        { type: 'new', text: 'Полностью переработанный интерфейс' },
        { type: 'new', text: 'Встроенная консоль для отладки скриптов' },
        { type: 'new', text: 'Синхронизация настроек через облако' },
        { type: 'improved', text: 'Улучшена совместимость со всеми скриптами' }
      ]
    },
    {
      version: '2.9.2',
      ...
      changes: [
        ...
        { type: 'improved', text: 'Улучшена работа автообновления' },
        { type: 'fixed', text: 'Устранены баги при работе с большими скриптами' }
      ]
    },
    {
      version: '2.9.0',
      ...
      type: 'minor',
      changes: [
        { type: 'new', text: 'Добавлена система плагинов' },
        { type: 'new', text: 'Расширенная библиотека скриптов' },
        { type: 'improved', text: 'Улучшена производительность редактора кода' },
        { type: 'fixed', text: 'Исправлены баги интерфейса' }
      ]
    },
    {
      version: '2.8.1',
      ...
      changes: [
        ...
        { type: 'fixed', text: 'Устранены проблемы с запуском скриптов' }
      ]
    }
  ];
